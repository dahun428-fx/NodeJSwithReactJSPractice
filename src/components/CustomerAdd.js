    ...
    render(){
        return(
         ...
         <Dialog open={this.state.open} onClose={this.handleClose}>
            ...
            <DialogContent>
            <input  className={styles.hidden} accept="image/*"  
               id="raised-button-file"  type="file" name="file" file={this.state.file} 
         ...
         <DialogActions>
            ...
            //     <br/>
            //     성별 :
            //      <input type="text" name="gender" value={this.state.gedner} onChange={this.handleValueChange}/>
            //     <br/>
